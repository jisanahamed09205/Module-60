...
async function run() {
  try {
    ...
    const bookingCoolection = client.db('carDoctor').collection('bookings');
    ...
    app.get('/servicesCheckOut/:id',async(req,res)=>{
    ...
    app.get('/bookings',logger,verifyToken,async(req,res)=>{
      ...
      console.log('valid token er kach theka asciii',req.user);
